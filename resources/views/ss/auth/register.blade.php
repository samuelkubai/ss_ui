        ...
        <div class="col-md-6">
            <div class="ibox-content">
                <form class="m-t" role="form" action="index.html">
                    ...
                    <button type="submit" class="btn btn-primary block full-width m-b">Next <i class="fa fa-arrow-right"></i></button>

                    <span class="text-center">Step 1 of 3</span>

                    <p class="text-muted text-center">
                        <small>Do you already have an account?</small>
                    </p>
                    <a class="btn btn-sm btn-white btn-block" href="{{ url('/register') }}">Login</a>
                </form>
            </div>
        </div>
    </div>
