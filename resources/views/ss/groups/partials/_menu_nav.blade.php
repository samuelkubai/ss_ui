    ...
    <div class="panel blank-panel">
        ...
        <div class="panel-body ">
            <ul class="group-navigation">
                <li class="active"><a href="{{ url('group') }}" class="btn btn-lg btn-rounded btn-primary"><i class="fa fa-laptop"></i></a></li>
                ...
                <li class=""><a href="{{ url('group/update') }}" class="btn btn-lg btn-rounded btn-white"><i class="fa fa-edit"></i></a></li>
            </ul>
