...
ssModule.controller('SingleGroupMemberController', ['$scope','groupService', 'toaster','fileService',
    function($scope, groupService, toaster, fileService){
        ...
        $scope.init = function() {
            ...
            groupService.getGroupMemberActivities(groupUsername,userId, params).success(function(data) {
